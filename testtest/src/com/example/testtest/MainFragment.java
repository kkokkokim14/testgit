...
public class MainFragment extends BrowseFragment {
	...
	private void loadRows() {
		...
		ArrayObjectAdapter gridRowAdapter = new ArrayObjectAdapter(
				mGridPresenter);
		gridRowAdapter.add(getResources().getString(R.string.grid_view));
		gridRowAdapter.add(getResources().getString(R.string.send_feeback));
		gridRowAdapter
				.add(getResources().getString(R.string.personal_settings));
	...
	private void setupUIElements() {
		...
		setTitle(getString(R.string.browse_title)); // Badge, when set, takes
													// precedent
													// over title
	...
	protected void updateBackground(URI uri) {
		Picasso.with(getActivity()).load(uri.toString())
				...
				.centerCrop().error(mDefaultBackground).into(mBackgroundTarget);
	}
